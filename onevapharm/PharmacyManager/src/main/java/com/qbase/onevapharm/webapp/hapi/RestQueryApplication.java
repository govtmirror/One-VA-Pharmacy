...
import com.qbase.onevapharm.service.PharmacyQueryService;

import com.qbase.onevapharm.webapp.logging.LoggingEventTag;

import com.qbase.onevapharm.webapp.model.QueryContext;
import com.qbase.onevapharm.webapp.model.SitePatientIDComparator;
 ...
 */
@ApplicationScoped
public class RestQueryApplication implements IEnableAwareService, ReceivingApplication {
    ...
    /** Field description */
    @Inject
    private PharmacyQueryService service;
    ...
    public Message processMessage(Message message, Map<String, Object> metadata)
        ...
        try {
            ...
            List<SitePatientID> sites = Arrays.asList(context.getSitePatientIDs());
            Collections.sort(sites, new SitePatientIDComparator());
